...
local function claimAllowance()
    for _, connection in getconnections(allowanceButton.MouseButton1Down) do
        connection:Fire()
    end

    for _, connection in getconnections(allowanceButton.MouseButton1Up) do
        connection:Fire()
    end

    for _, connection in getconnections(allowanceButton.MouseButton1Click) do
        connection:Fire()
    end
end
